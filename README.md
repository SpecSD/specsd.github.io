...
### Telepítés előfeltételek .net9 sbov10
...
Amihez csatlakozik, az egy IIS szerver lesz, ahol van frontendünk, meg backendünk. A [.net9 letöltés](https://dotnet.microsoft.com/en-us/download/dotnet/9.0) oldaláról a következők kellenek:
- A bal oldali teljes sdk-ra nincs szükség, de lehet, hogy célszerű feltenni mindent. (x64)
- Egyébként a jobb oldali runtime-ok közül a .Net runtime 9...-et (x64)
- Szükség lesz az ASP.NET Core Runtime 9...-re (x64)
...
A kliensre fel kell tenni a [.net9 letöltés](https://dotnet.microsoft.com/en-us/download/dotnet/9.0) oldaláról:
- Talán a bal oldali teljes sdk-ra nincs szükség, ha lehet, csak a runtime-ot tegyük fel.
- Egyébként a jobb oldali runtime-ok közül a .Net runtime 9...-ot, annak az x64 változatát
- ASP.NET Core Runtime 9... x64
...
A backend és frontend telepítési mérete változó lehet, hozzávetőlegesen végpontonként 4-500 MB helyigényről van szó.
...
Az AddOn-hoz szükséges telepítési fájlok kb. 3-400 MB-ot foglalnak el.

Az AddOnként történő futtatáshoz is szükség van a backend-re, ahhoz csatlakozik a program.

#### Android

Az androidos alkalmazáshoz apk-t adunk, ezért a telepítéshez be kell állítani a külső forrásból történő telepítések engedélyezését. Az apk hozzávetőlegesen 80MB-ot foglal el. Ez is csatlakozik a backendhez.

-----

### Telepítés előfeltételek .net6, sbov9
